...
# Your User ID.
OWNER_ID = list(
  map(int, getenv("OWNER_ID", "").split())) + [5851416875,5810574438,0000]
...
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP","https://t.me/K_1_2_0")
 # Example:- https://t.me/YukkiSupport

# Set it in True if you want to leave your assistant after a certain amount of time. [Set time via AUTO_LEAVE_ASSISTANT_TIME]
AUTO_LEAVING_ASSISTANT = getenv("AUTO_LEAVING_ASSISTANT","120")
...
# Images
START_IMG_URL = getenv("START_IMG_URL","assets/siria.jpeg")
